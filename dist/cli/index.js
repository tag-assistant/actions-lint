...
const unpinned_actions_1 = __nccwpck_require__(476);
const missing_permissions_1 = __nccwpck_require__(690);
const missing_timeout_1 = __nccwpck_require__(1);
const hardcoded_secrets_1 = __nccwpck_require__(283);
const missing_concurrency_1 = __nccwpck_require__(409);
const deprecated_actions_1 = __nccwpck_require__(404);
const deprecated_features_1 = __nccwpck_require__(456);
const artifact_retention_1 = __nccwpck_require__(346);
const pull_request_target_1 = __nccwpck_require__(156);
const shell_injection_1 = __nccwpck_require__(805);
const large_checkout_depth_1 = __nccwpck_require__(353);
const rules = [
    unpinned_actions_1.unpinnedActions, missing_permissions_1.missingPermissions, missing_timeout_1.missingTimeout, hardcoded_secrets_1.hardcodedSecrets,
    missing_concurrency_1.missingConcurrency, deprecated_actions_1.deprecatedActions, deprecated_features_1.deprecatedFeatures, artifact_retention_1.artifactRetention,
    pull_request_target_1.pullRequestTarget, shell_injection_1.shellInjection, large_checkout_depth_1.largeCheckoutDepth,
];
...
function lint(files) {
    ...
    for (const filePath of files) {
        ...
        let parsed;
        try {
            parsed = (0, parser_1.parseWorkflow)(content);
        }
        catch (e) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.artifactRetention = void 0;
const parser_1 = __nccwpck_require__(196);
exports.artifactRetention = {
            ...
            for (const step of job?.steps ?? []) {
                ...
                if (step.uses.startsWith('actions/upload-artifact@')) {
                    if (!step.with?.['retention-days']) {
                        results.push({
                            file, line: (0, parser_1.findLineNumber)(content, step.uses),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deprecatedActions = void 0;
const parser_1 = __nccwpck_require__(196);
const DEPRECATED = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deprecatedFeatures = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hardcodedSecrets = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.largeCheckoutDepth = void 0;
const parser_1 = __nccwpck_require__(196);
exports.largeCheckoutDepth = {
        ...
        for (const [, job] of Object.entries(parsed.jobs)) {
            for (const step of job?.steps ?? []) {
                ...
                if (step.with?.['fetch-depth'] === 0 || step.with?.['fetch-depth'] === '0') {
                    results.push({
                        file, line: (0, parser_1.findLineNumber)(content, 'fetch-depth'),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.missingConcurrency = void 0;
exports.missingConcurrency = {
...
exports.missingPermissions = {
    ...
    check(file, _content, parsed) {
        ...
        const jobsHavePerms = Object.values(parsed.jobs).every(j => j?.permissions);
        if (jobsHavePerms)
            return [];
        return [{
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.missingTimeout = void 0;
const parser_1 = __nccwpck_require__(196);
exports.missingTimeout = {
    ...
    check(file, content, parsed) {
        ...
        for (const [name, job] of Object.entries(parsed.jobs)) {
            if (!job?.['timeout-minutes']) {
                results.push({
                    file, line: (0, parser_1.findLineNumber)(content, `${name}:`),
...
exports.pullRequestTarget = {
    ...
    check(file, content, parsed) {
        ...
        results.push({
            file, line: (0, parser_1.findLineNumber)(content, 'pull_request_target'),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.shellInjection = void 0;
const DANGEROUS_CONTEXTS = (/* unused pure expression or super */ null && ([
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.unpinnedActions = void 0;
const parser_1 = __nccwpck_require__(196);
exports.unpinnedActions = {
    ...
    check(file, content, parsed) {
        ...
        for (const [, job] of Object.entries(parsed.jobs)) {
            for (const step of job?.steps ?? []) {
                ...
                if (!isSHA && !isSemver) {
                    results.push({
                        file, line: (0, parser_1.findLineNumber)(content, uses),
